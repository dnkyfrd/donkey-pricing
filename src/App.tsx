...
function findMatchingCountry(
  ...
  return (
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {/* Student Plan - Only show for MetropolRadRuhr */}
                     {isMetropolRadRuhr && (
                      <div className="grid gap-3 grid-cols-1 max-w-xs mx-auto w-full">
                        <div className="relative bg-gradient-to-br from-orange-50/20 via-white to-blue-50/20 rounded-xl border-2 p-4 text-center transition-all hover:shadow-xl hover:scale-105 overflow-hidden border-orange-200/60 hover:border-orange-400 hover:bg-gradient-to-br hover:from-orange-100/30 hover:via-white hover:to-blue-100/30">
                          ...
                          <div className="mb-3">
                            <span className="text-xl font-bold text-slate-900">{t('free')}</span>
                          </div>
                          <div className="space-y-1 text-xs text-slate-600">
                            <div>{t('first_x_minutes_included', { minutes: 60 })}</div>
                            <div>{t('price_for_each_additional_x_mins', { price: '€0.50', minutes: 30 })}</div>
    ...
    <h3 className="text-base font-bold text-slate-900 mb-2 text-center">{vehicleLabels[dayDeal.vehicle_type as VehicleType] || t('unknown_bike')}</h3>
